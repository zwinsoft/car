    		...
    		if(IS_POST)
				{
					...
					{
						$company = M('company');
						$company->where("id=".session("user_id"))->setField('flag2','1');
								
						$this->success("提交成功,请继续填写项目资金还款计划", U('Project/Info2'));	
					}else
					{
						$this->success("保存成功");
					}
    		...
    		if(IS_POST)
				{
					...
					{
						$company = M('company');
						$company->where("id=".session("user_id"))->setField('flag3','1');
							
						$this->success("提交成功,请继续填写附表1", U('Company/Attach1'));
